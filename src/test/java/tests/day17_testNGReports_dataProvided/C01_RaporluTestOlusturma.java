...
public class C01_RaporluTestOlusturma extends TestBaseRapor {
    ...
    public void aramaTesti(){
      ...
      Assert.assertTrue(aramaSonucSayisi>0);
        extentTest.info("arama sonucunda urun bulunabildigini test eder");
        ...
        extentTest.info("acilan urun sayfasinda urun isminin case sensitive olmadan belirlenen arama kelimesi icerdigini test eder");
